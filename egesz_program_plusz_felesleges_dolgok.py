...
for sor in elso_bin:
    fin = str(sor)
    finomitas.append(fin)
elso_bin = "".join(finomitas)
...
for sor in n_elso_bin:
    fin2 = str(sor)
    finomitas2.append(fin2)
n_elso_bin = "".join(finomitas2)
...
#_______________________________________uj_felvilágosodás___________________---
